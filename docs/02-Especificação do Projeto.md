...
|RF-005| A aplicação deverá listar todos os itens cadastrados   | ALTA |
|RF-006| A aplicação deverá listar os itens próximos a vencer    | MÉDIA |
|RF-007| Deverá ser exibido informações sobre o item cadastrado    | ALTA |
|RF-008| A aplicação deverá permitir que o usuário pesquise um item por Nome, validade ou quantidade     | ALTA |
|RF-009| Deve conter uma opção para retirada do item em estoque, tendo obrigatoriamente de informar o motivo (Validade, Requisitado, Outros)      | ALTA |
